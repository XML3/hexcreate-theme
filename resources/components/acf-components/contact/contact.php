...
<div class="block xl:hidden pointer-events-auto items-center">
    ...
    <div class="bg-secondary py-16 px-6">
        ...
        <div class="bg-primary p-4 rounded-2xl w-full mt-6">
            <?php echo do_shortcode('[fluentform id="8"]') ?>
        </div>
    </div>
    <!-- Bottom section - textmask -->
    <div class="bg-accent py-16 px-6 mb-8">
        <div class="space-y-8">
            <h2 class="vertical-text-scroll font-manrope normal-60 text-primary text-left xl:text-left"><?php echo esc_html($contact_title); ?></h2>
            <div class="vertical-text-scroll font-inter normal-18 text-secondary text-left xl:text-left "><?php echo wp_kses_post($contact_form); ?></div>
        </div>
        <div class=" bg-primary p-4 xl:p-10 rounded-2xl mt-8">
            <?php
...
<!--Desktop-->
<section class="hidden xl:block  relative min-h-screen tall-tablet-scroll short-mobile-scroll ">
    ...
    <div class="relative container-wide mx-auto h-full min-h-screen flex items-center">
        <div class="grid grid-cols-1 xl:grid-cols-2 w-full mt-8 xl:mt-0">
